...
BEGIN  
    ...
    -- Registro de cambios en la columna nombre_usuario
    IF OLD.nombre_usuario != NEW.nombre_usuario THEN
        INSERT INTO auditoria_tbl_ms_usuario (tipo_operacion, id_usuario_afectado, nombre_usuario_afectado, id_usuario_operacion, nombre_usuario_operacion, tabla_afectada, detalle_anterior, detalle_posterior)  
        VALUES ('UPDATE', NEW.id_usuario, NEW.nombre_usuario, id_usuario_operacion, nombre_usuario_operacion, 'tbl_ms_usuario', 
                CONCAT('Detalle anterior en columna nombre_usuario: ', OLD.nombre_usuario), 
                CONCAT('Detalle posterior en columna nombre_usuario: ', NEW.nombre_usuario));  
    END IF;
    
    -- Registro de cambios en la columna contraseña
    IF OLD.contraseña != NEW.contraseña THEN
        INSERT INTO auditoria_tbl_ms_usuario (tipo_operacion, id_usuario_afectado, nombre_usuario_afectado, id_usuario_operacion, nombre_usuario_operacion, tabla_afectada, detalle_anterior, detalle_posterior)  
        VALUES ('UPDATE', NEW.id_usuario, NEW.nombre_usuario, id_usuario_operacion, nombre_usuario_operacion, 'tbl_ms_usuario', 
                CONCAT('Detalle anterior en columna contraseña: ', OLD.contraseña), 
                CONCAT('Detalle posterior en columna contraseña: ', NEW.contraseña));  
    END IF;
...
BEGIN  
    ...
    -- Insertar en la tabla de auditoría 
    INSERT INTO auditoria_tbl_ms_usuario (tipo_operacion, id_usuario_afectado, nombre_usuario_afectado, id_usuario_operacion, nombre_usuario_operacion, tabla_afectada, detalle_anterior, detalle_posterior)  
    VALUES ('DELETE', OLD.id_usuario, OLD.nombre_usuario, id_usuario_operacion, nombre_usuario_operacion, 'tbl_ms_usuario', 
...
-- Dump completed on 2024-04-23 22:47:56
